...
public class StorageService {	
	...
	public static boolean modifyEMailAddress(String pseudo, String newEMailAddress) throws SQLException, Exception {
		boolean modifyEMailAddress = false;
		Connection dbConn = null;
		try {
			try {
				dbConn = StorageService.createConnection();
